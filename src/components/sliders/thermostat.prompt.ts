...
- The heading is a 12px flex row with 20px line-height, items centered, spaced apart, 12px gap. The “°C” span is light-dark(#6b6b63, #9c9c91), 11px monospace, normal letter-spacing, tabular numerals.
...
- Ticks sit in a 12px-high flex row, spaced apart, aligned to the top, with 6px horizontal margins and pointer-events none: each is 1px by 4px in light-dark(#c6c8ba, #4a4b43) and majors are 7px high. Endpoint labels are a flex row spaced apart, 7px top margin, 10px monospace, color light-dark(#6b6b63, #9c9c91).
