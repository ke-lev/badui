...
- The face is sized in percentages of the companion. The face span is absolutely positioned with inset 0 and will-change transform. Each eye is absolutely positioned at top 26%, 14% wide and 22% tall, border-radius 999px, background light-dark(#282824, #e8e7e0); the left eye at left 26%, the right eye at right 26%. The mouth is absolutely positioned at top 56%, left 50%, transform translateX(-50%); 34% wide and 14% tall; border-bottom 1.5px solid light-dark(#282824, #e8e7e0); border-radius 0 0 50% 50% / 0 0 100% 100%, drawing a shallow smile.- With data-eating on the companion, the eyes keep their size and position, and the mouth becomes a hollow ellipse centred on one line: top 62%, width 7px, height 3px, border 1.5px solid light-dark(#282824, #e8e7e0) on all sides, border-radius 999px, no background, transform translate(-50%, -50%). Sizes are border-box, so when shut its two strokes meet in a single line. The chewing sets its width, height, and transform inline over these. The switch into and out of the eating face is immediate, with no transition.
${READOUT_STYLING}
