...
- The list and empty panel have a 1px solid light-dark(#deded6, #34342f) border, 6px radius, light-dark(#ffffff, #1a1a17) background. Items are flex rows, space-between, 12px gap, min-height 46px, padding 0 6px 0 14px, 13px type, with a 1px solid light-dark(#eaeaea, #2a2a26) border between items. The empty panel is a centered grid with 12px gap, padding 28px 16px, 12px light-dark(#6b6b63, #9c9c91) type.
- Delete buttons: min-height 32px, padding 4px 10px, transparent border and background, 5px radius, light-dark(#6b6b63, #9c9c91) 12px type; hover light-dark(#f7f7f2, #20201d) background and light-dark(#282824, #e8e7e0) text. Restore all: min-height 39px, padding 8px 15px, 1px solid light-dark(#deded6, #34342f) border, 5px radius, light-dark(#ffffff, #1a1a17) background, light-dark(#45453f, #c3c3b9) text, 12px weight 500; hover border light-dark(#bdbeb1, #4a4b43) and background light-dark(#f7f7f2, #20201d).
