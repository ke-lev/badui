...
- Use a controlled input with no name attribute and type=“text” at all times, never type=“password”; while the password is hidden it carries a class setting -webkit-text-security: disc, with the unprefixed text-security: disc beside it, and revealing it removes that class. Give it autocomplete “off”, spellcheck false, autocapitalize “none”, autocorrect “off”, and placeholder “Enter password”. Set data-1p-ignore, data-lpignore, data-bwignore and data-form-type=“other” so password managers leave it alone. Because the input is not a native password field, a screen reader reads the typed characters aloud. Connect it with aria-describedby to the requirements list and set aria-invalid=true only after a submit attempt.
...
- The input shell is a 45px-high flex row with 9px top margin, 1px solid light-dark(#868b7c, #a0a892) border, 5px radius, light-dark(#ffffff, #1a1a17) background, and hidden overflow. On focus-within use border light-dark(#7a8565, #97a37f) and a 3px 11%-opacity light-dark(#7a8565, #97a37f) ring; after submit use border light-dark(#9a6b2f, #d6a764).
- The input fills the shell with 12px horizontal padding, no border or outline, transparent background, and 14px inherited type. Placeholder is light-dark(#6b6b63, #9c9c91). The reveal control stretches vertically, min-width 53px, no border, transparent background, 11px sans-serif, color light-dark(#6b6b63, #9c9c91); hover is light-dark(#282824, #e8e7e0) on light-dark(#f4f4ef, #1d1d1a) and focus is a 2px light-dark(#667251, #8e9c78) inset outline at -4px offset.
- The requirement list reserves min-height 100px, margin 15px 0 13px, no padding or bullets, color light-dark(#6b6b63, #9c9c91). Rows are min-height 24px, 12px type, 7px gap. Met rows are light-dark(#667251, #8e9c78); submitted unmet rows are light-dark(#9a6b2f, #d6a764). Status marks occupy 16px square; unmet uses a 5px circular outline.
...
- Center the success panel vertically with an 18px gap. Its icon is 36px circular with border light-dark(#e3e6d7, #3a4231), background light-dark(#e6e9dc, #2b3125), color light-dark(#667251, #8e9c78). Title is 18px medium with -0.5px tracking. The restart button is light-dark(#ffffff, #1a1a17) with border light-dark(#deded6, #34342f), light-dark(#45453f, #c3c3b9) text, and the same size and focus treatment as the primary button.
