...
- The heading is a 12px flex row with 20px line-height, items centered and spaced apart; the icon is #838377.
- The output is block-level with 24px top and 21px bottom padding, a 1px solid #deded6 bottom border, nowrap, tabular numerals, and a monospace stack. Its font size is clamp(25px, 2.8vw, 32px), line-height 1.3, letter-spacing -1.5px.
...
- The track is 2px high with background #c7c7bc. The WebKit thumb is 14px by 26px with margin-top -12px, 4px solid #ffffff border, 3px radius, 1px #b9bbae outline, and #879271 fill. The Firefox thumb is 6px by 18px with the same border, radius, outline, and fill.
- The range focus-visible outline is 2px solid #6c7660 with 2px radius. Ticks sit in a 12px-high flex row with 6px horizontal margins: each is 1px by 4px in #d2d2c6 and majors are 7px high. Endpoint labels are spaced apart, 7px above margin, 10px monospace, color #6b6b63.
