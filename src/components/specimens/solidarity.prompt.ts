...
- The custom box is 19px square, flex-shrink 0, 1px solid light-dark(#868b7c, #a0a892) border, 3px radius, light-dark(#ffffff, #1a1a17) background, with a centered decorative check. When checked use border light-dark(#7a8565, #97a37f), background light-dark(#e6e9dc, #2b3125), and check color light-dark(#4e6145, #a9b894). Hover border is light-dark(#899176, #717b5f). Input focus-visible gives the custom box a 2px solid light-dark(#667251, #8e9c78) outline at 3px offset.
...
- The success panel is width 100%, centered, vertical with 18px gap. Its circular check is 36px with border light-dark(#e3e6d7, #3a4231), background light-dark(#e6e9dc, #2b3125), color light-dark(#667251, #8e9c78). Title is 18px medium with -0.5px tracking; description is 12px light-dark(#6b6b63, #9c9c91) with margin -9px 0 0. Edit is a light-dark(#ffffff, #1a1a17) secondary button with light-dark(#deded6, #34342f) border and light-dark(#45453f, #c3c3b9) text.
