...
- Use a 42px normal-weight monospace reading with line-height 1.1, letter-spacing -3px, tabular numerals. Position the 13px light-dark(#77776b, #9c9c91) percent sign at top 8px with 4px left margin. Use 11px light-dark(#6b6b63, #9c9c91) for the label and hint.
