...
STYLING
- The specimen is width 100%, max-width 320px, centered, color #282824, and a vertical flex layout aligned center with a 15px gap.
- The dial is position relative, 224px square, circular, touch-action none, user-select none, cursor grab, and cursor grabbing while dragged. Its focus-visible outline is 2px solid #6c7660 with 7px offset.
- Major ticks use stroke #9d9d92 at width 1; minor ticks use #d4d4c9 at width 1.
- Inset the face by 29px; give it a 1px solid #deded6 border and #ffffff background. Inset the hand by 10px. Its marker is 4px by 12px, top 2px, centered horizontally, radius 2px, background #858e70.
- Use a 42px normal-weight monospace reading with line-height 1.1, letter-spacing -3px, tabular numerals. Position the 13px #77776b percent sign at top 8px with 4px left margin. Use 11px #6b6b63 for the label and hint.
